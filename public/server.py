...
pyautogui.FAILSAFE = True  # Move mouse to any screen corner to emergency abort
...
async def screen_stream_worker():
    ...
    while True:
        if connected_clients and stream_settings["streaming"]:
            ...
            jpeg_bytes, _, _ = capture_screen_jpeg(
    ...
    try:
        async for message in websocket:
            try:
                ...
                print("[!] PyAutoGUI FailSafe triggered. Pausing action.")
            except Exception:
                pass
